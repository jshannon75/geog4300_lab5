...
**Question 7 (2 points)** _Reload the original CPS dataset (so that you're not filtering out based on EARNWEEK as you did in question 1). Now filter for records with valid responses to FSFDBNK (<6 on the scale) that are in the states listed above. Call the head of the table when done_
